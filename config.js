...
global.sudo = process.env.SUDO || "923192173398, 263777756184";
global.owner = process.env.OWNER_NUMBER || "263777756184";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "𝐅𝐈𝐋𝐄-𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃-𝐁𝐘-Joshking😍",
  author: process.env.PACK_AUTHER || "Joshking",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "Joshuamambomd",
  ownername: process.env.OWNER_NAME || "Joshkingmd",
  errorChat: process.env.ERROR_CHAT || "923192173398",
  KOYEB_API: process.env.KOYEB_API || "false",
  REMOVE_BG_KEY: process.env.REMOVE_BG_KEY || "",
  OPENAI_API_KEY: process.env.OPENAI_API_KEY || "",
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || "HRKU-5294c1d4-146f-4246-97fb-63854e887c09",
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || "joshkingmd",
